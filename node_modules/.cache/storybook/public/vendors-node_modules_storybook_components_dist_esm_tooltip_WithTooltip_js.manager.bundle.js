"use strict";
(self["webpackChunk_zendeskgarden_react_components"] = self["webpackChunk_zendeskgarden_react_components"] || []).push([["vendors-node_modules_storybook_components_dist_esm_tooltip_WithTooltip_js"],{
...
function getClientRectFromMixedType(element, clippingParent) {
  return clippingParent === enums.viewport ? rectToClientRect(getViewportRect(element)) : isHTMLElement(clippingParent) ? getInnerBoundingClientRect(clippingParent) : rectToClientRect(getDocumentRect(getDocumentElement(element)));
