...
import React__default, { createContext, useContext, useRef, useEffect, useMemo, useState, forwardRef } from 'react';
...
var Header$1 = React__default.forwardRef(function (props, ref) {
  ...
  return React__default.createElement(StyledHeader, _extends$2({
    ref: ref
  }, getTitleProps(props)), props.isDanger && React__default.createElement(StyledDangerIcon, null), props.children);
});
...
var Body$1 = React__default.forwardRef(function (props, ref) {
  var _useTooltipModalConte = useTooltipModalContext(),
...
var Close$1 = React__default.forwardRef(function (props, ref) {
  var _useTooltipModalConte = useTooltipModalContext(),
...
var TooltipModal = React__default.forwardRef(function (_ref, ref) {
