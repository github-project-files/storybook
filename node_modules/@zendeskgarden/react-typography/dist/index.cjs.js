...
var fontStyles = function fontStyles(props) {
  ...
  if (monospace) {
    if (props.size === 'inherit') {
      ...
      fontSize = polished.math("".concat(props.theme.fontSizes[props.size], " - 1px"));
      lineHeight = polished.math("".concat(props.theme.lineHeights[props.size], " - 1px"));
    }
...
var colorStyles$3 = function colorStyles(props) {
  ...
  var foregroundColor = reactTheming.getColor(hue, shade, props.theme);
...
var _excluded$d = ["tag"];
var SM = React__default['default'].forwardRef(function (_ref, ref) {
  var tag = _ref.tag,
...
var _excluded$c = ["tag"];
var MD = React__default['default'].forwardRef(function (_ref, ref) {
  var tag = _ref.tag,
...
var _excluded$b = ["tag"];
var LG = React__default['default'].forwardRef(function (_ref, ref) {
  var tag = _ref.tag,
...
var _excluded$a = ["tag"];
var XL = React__default['default'].forwardRef(function (_ref, ref) {
  var tag = _ref.tag,
...
var _excluded$9 = ["tag"];
var XXL = React__default['default'].forwardRef(function (_ref, ref) {
  var tag = _ref.tag,
...
var _excluded$8 = ["tag"];
var XXXL = React__default['default'].forwardRef(function (_ref, ref) {
  var tag = _ref.tag,
...
var Code = React__default['default'].forwardRef(function (_ref, ref) {
  var size = _ref.size,
      hue = _ref.hue,
...
var CodeBlock = React__default['default'].forwardRef(function (_ref, ref) {
  ...
  var containerTabIndex = containerScrollregion.useScrollRegion({
  ...
  return React__default['default'].createElement(StyledCodeBlockContainer, _extends({}, containerProps, {
    ...
    return React__default['default'].createElement(StyledCodeBlock, _extends({
      ...
      return React__default['default'].createElement(StyledCodeBlockLine, _extends({}, getLineProps({
        line: line
      }), {
        key: index,
        language: language,
...
var _excluded$4 = ["tag"];
var Span = React__default['default'].forwardRef(function (_ref, ref) {
  var tag = _ref.tag,
...
var Paragraph = React__default['default'].forwardRef(function (_ref, ref) {
  var size = _ref.size,
...
var useOrderedListContext = function useOrderedListContext() {
  var listContext = React.useContext(OrderedListContext);
  if (!listContext) {
...
var OrderedListItem = React__default['default'].forwardRef(function (props, ref) {
...
var OrderedList = React__default['default'].forwardRef(function (_ref, ref) {
  var size = _ref.size,
      type = _ref.type,
...
var useUnorderedListContext = function useUnorderedListContext() {
  var listContext = React.useContext(UnorderedListContext);
  if (!listContext) {
...
var UnorderedListItem = React__default['default'].forwardRef(function (props, ref) {
...
var UnorderedList = React__default['default'].forwardRef(function (_ref, ref) {
  var size = _ref.size,
      type = _ref.type,
